...
const base = 'bg-yellow-400 px-2 py-1 text-md font-semibold rounded-full hover:bg-yellow-500 transition-colors duration-300 focus:ring focus:ring-yellow-500 focus:ring-offset-1 disabled:cursor-not-allowed '
const styles = {
  primary : base + ' px-4 py-3 md:px-6 md:py-3 uppercase',
  small : base + 'px-4 py-2 md:px-6 md:py-3 text-md',
